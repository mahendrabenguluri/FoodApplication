<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="java.util.List, com.food.model.Menu,com.food.model.User,com.food.model.Restaurant,java.util.Base64,java.io.*,java.sql.*"%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
.restaurant-container {
    ...
    width: 80%;
            ...
            margin: 15px auto;
            border: none;
            box-shadow: 0 5px 4px 0 rgba(1,0,0,0.1);
...
.add-menu-btn {
    background-color: #942908;
    color: white;
}

.modify-btn:hover {
    background-color: rgb(21, 120, 21);
}
...
.restaurant-container a.modify-btn1 {
    padding: 12px 20px;
    max-width: 130px; 
    background-color: #942908;
    color: white;
...
.restaurant-container a.modify-btn1:hover {
    background-color: #822509;
}
...
<!--             <div class="nav-item">
    ...
    <div class="restaurant-container">
        <h1>Restaurant</h1>
                     <% 
            List<Restaurant> restaurantList = (List<Restaurant>) request.getAttribute("restaurantsByAdmin");
            if (restaurantList != null && !restaurantList.isEmpty()) {
                for (Restaurant restaurant : restaurantList) {
                    /* Blob imageBlob = restaurant.getImagePath();
 ...
 <div class="restaurant-item">
    <div class="restaurant-image">
        <img src="<%= restaurant.getImagePath() %>" alt="Image of <%= restaurant.getName() %>">
    </div>
    <div class="restaurant-details">
        ...
        <div class="restaurant-buttons">
            <!-- Modify Restaurant Details button -->
            <a href="RestaurantDetails.jsp?restaurantId=<%= restaurant.getRestaurant_Id() %>" class="modify-btn">Modify Details</a>
            ...
            <form action="MenuItems" method="post">
	            ...
	            <button type="submit" class="add-menu-btn">Menu Items</button>
            </form>
            
            <form action="RestaurantMenuDelete" method="post">
                        <input type="hidden" name="restaurantId" value="<%= restaurant.getRestaurant_Id() %>">
                        <input type="hidden" name="from" value="restaurant">
        ...
        <a href="RestaurantDetails.jsp" class="modify-btn1"  style="text-decoration: none;">Add Restaurants</a>
    </div>
              <script>
              // Sign up
          ...
          document.getElementById("profile").addEventListener("click", function() {
            ...
            document.getElementById("login").addEventListener("click", function() {
                /* alert("Redirecting to Login.jsp"); */ // Use alert for testing
                window.location.href = "Login.jsp"; // Ensure this path is correct
            });
